    ...
    <Stack spacing={3}>
      ...
      <Grid container spacing={2}>
        ...
        <Grid size={{ xs: 12 }}>
          <TextField
            ...
            value={p.managementStyle || ''}
            onChange={(e) => setProfileField('managementStyle', e.target.value)}
            fullWidth
            size="small"
          />
        </Grid>
        <Grid size={{ xs: 12 }}>
          <TextField
            ...
            value={p.workStylePreferences || ''}
            onChange={(e) => setProfileField('workStylePreferences', e.target.value)}
            fullWidth
            size="small"
          />
        </Grid>
        <Grid size={{ xs: 12 }}>
          <TextField
            ...
            type="number"
            value={p.salaryMin || ''}
            onChange={(e) => setProfileField('salaryMin', e.target.value)}
            fullWidth
            size="small"
          />
        </Grid>
        <Grid size={{ xs: 12 }}>
          <TextField
            ...
            type="number"
            value={p.salaryMax || ''}
            onChange={(e) => setProfileField('salaryMax', e.target.value)}
            fullWidth
            size="small"
          />
        </Grid>
        <Grid size={{ xs: 12 }}>
          <TextField
            ...
            type="url"
            value={p.linkedInUrl || ''}
            onChange={(e) => setProfileField('linkedInUrl', e.target.value)}
            fullWidth
            size="small"
          />
        </Grid>
        <Grid size={{ xs: 12 }}>
          <TextField
            ...
            type="url"
            value={p.githubUrl || ''}
            onChange={(e) => setProfileField('githubUrl', e.target.value)}
            fullWidth
            size="small"
          />
        </Grid>
      ...
      <Stack spacing={2}>
        <TextField
          ...
          value={p.elevatorPitch || ''}
          onChange={(e) => setProfileField('elevatorPitch', e.target.value)}
          fullWidth
          multiline
          rows={3}
          size="small"
        ...
        <TextField
          ...
          value={p.careerNarrative || ''}
          onChange={(e) => setProfileField('careerNarrative', e.target.value)}
          fullWidth
          multiline
          rows={5}
          size="small"
        ...
        <TextField
          ...
          value={p.lookingFor || ''}
          onChange={(e) => setProfileField('lookingFor', e.target.value)}
          fullWidth
          multiline
          rows={3}
          size="small"
        ...
        <TextField
          ...
          value={p.notLookingFor || ''}
          onChange={(e) => setProfileField('notLookingFor', e.target.value)}
          fullWidth
          multiline
          rows={3}
          size="small"
            ...
            <TextField
              ...
              onKeyDown={(e) => {
                ...
                setAdminData((prev) => ({
                  ...
                  profile: {
                    ...prev.profile,
                    targetTitles: [...(prev.profile.targetTitles || []), value],
                  },
                }));
                setTargetTitleInput('');
              }}
